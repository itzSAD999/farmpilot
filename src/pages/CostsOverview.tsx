            ...
            <div className="space-y-4">
              {categoryTotals.map(({ category, total, count }) => {
                ...
                return (
                  <Link
                    key={category}
                    to={`/costs/category/${category}`}
                    className="block bg-white dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/10 shadow-sm hover:shadow-md hover:border-emerald-300 dark:hover:border-emerald-700 transition-all p-5 group"
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">{count} {count === 1 ? 'entry' : 'entries'} — tap to view every one</p>
                        </div>
                      </div>
