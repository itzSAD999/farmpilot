          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              <div className="bg-[#0a0a0a] rounded-[24px] p-6 shadow-xl relative overflow-hidden min-h-[250px] text-white flex flex-col justify-between">
                ...
                <div className="relative z-10 w-full mt-6 flex flex-col gap-2">
                  <button 
                    onClick={() => {
                      const event = new CustomEvent('open-farmbot');
                      window.dispatchEvent(event);
                    }}
                    className="w-full bg-white text-[#1B5E20] hover:bg-gray-100 font-bold py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-sm"
                  >
                  ...
                  <Link 
                    to="/guides"
                    className="w-full bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2"
                  >
